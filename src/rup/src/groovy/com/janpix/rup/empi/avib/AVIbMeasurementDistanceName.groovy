 ...
 *
 */
class AVIbMeasurementDistanceName extends MeasurementDistanceAttribute {
	...
	Double calculateDistance(Identity identity1, Identity identity2){
		return this.weight * this.calculateLevenshteinDistance(identity1.name, identity2.name)
	}
